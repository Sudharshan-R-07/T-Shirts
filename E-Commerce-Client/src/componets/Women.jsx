...
import { Link, useNavigate } from "react-router-dom";
  ...
  navigate("/cart");
    ...
    return (
        <>
            <div>
                <h1 className="text-5xl font-extrabold m-5 p-5">WOMENS</h1>
            </div>
            <div className="flex">
                <div className=" m-5 p-5 font-extralight">
                    ...
                    {/* <div className="mt-10 text-2xl font-light ">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            <input type="checkbox" onChange={()=>handlesize("L")}></input>
                            <p>Large</p>
                        </div>
                        <div className="flex items-center gap-2 mt-2">
                            <input type="checkbox" onChange={()=>handlesize("M")}></input>
                            <p>Medium</p>
                        </div>
                        <div className="flex items-center gap-2 mt-2">
                            <input type="checkbox" onChange={()=>handlesize("S")}></input>
                            <p>Small</p>
                        </div>
                    </div> */}
                </div>
